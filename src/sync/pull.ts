  ...
  for (const r of remoteInspections) {
    await db
      ...
      .values({
        ...
        tenantSignature: r.tenant_signature,
        tenantSignerName: r.tenant_signer_name,
        tenantSignedAt: ms(r.tenant_signed_at),
        landlordSignature: r.landlord_signature,
        landlordSignerName: r.landlord_signer_name,
        landlordSignedAt: ms(r.landlord_signed_at),
